...
console.log(addElements(new Set(["a", "b", "c"]), ["b", "c", "d", "e", "f"]));
...
console.log(
	filterAndAdd(new Set([1, 2, 3, "a", "b", "c"]), ["b", "c", "d", "e", "f"])
);
// Виведе: Set(6) { 'a', 'b', 'c', 'd', 'e', 'f' }
...
function setToArray(mySet) {
	const arrFromSet = Array.of(...mySet);
	return arrFromSet.filter((elem) => typeof elem === "string").sort();
...
function removeDuplicatesInPlace(arr) {
	...
	for (let index = 0; index < arr.length; index++) {
		if (uniqueSet.has(arr[index])) {
			arr.splice(index, 1);
			// console.log(arr);
			index--;
		} else {
			uniqueSet.add(arr[index]);
		}
	}
	return uniqueSet;
